...
public class HashFunction {
    ...
    public static String[] search(String word){
        ...
        String result = hash.search(word);
    ...
    private static void updateFile(String E_word,String C_word) {
        ...
        try {
            ...
            if(C_word.isEmpty()){
                ...
                hash.insert(E_word,C_word);
            }
            hash.Print();
            LinkedList<String> list = hash.getList();
    ...
    public static void readDict(String fileName, Hash hash) throws IOException {
